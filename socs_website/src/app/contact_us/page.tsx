...
export default function ContactUs() {
        ...
        <div className="bg-black min-h-screen">
            ...
            <section className="flex justify-between items-start mt-10 ml-20 relative">
                <div className="text-left ml-32">
                    <h1 className="text-white text-7xl mb-20">
                        CONTACT US
                    </h1>
                    <form className="text-white">
                        ...
                        <div className="flex flex-col gap-4"> {/* Display radio buttons vertically */}
    ...
    style={{
        ...
        borderImageSource: 'linear-gradient(103.75deg, #FFFFFF 29.85%, rgba(153, 153, 153, 0) 108.02%)',
        borderImageSlice: 1,
    }}
>
    Submit
